...
constexpr auto kValueFlags = std::to_array<ValueFlag>({
    ...
    {"",   "--set-signature", &Args::annotate_signature},
    {"",   "--confidence",   &Args::annotate_conf},
    {"",   "--evidence",     &Args::annotate_evidence},
    {"",   "--source",       &Args::annotate_source},
    ...
    {"",   "--debug-backend", &Args::debug_backend},
